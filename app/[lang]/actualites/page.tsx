...
export default async function ActualitesPage({ params }: { params: { lang: string } }) {
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h1 className=" text-h1 mb-6">
                {t(params.lang as Locale, 'actualites.title')}
              </h1>
              <p className="text-body text-text-muted">
                {t(params.lang as Locale, 'actualites.subtitle')}
              </p>
            </div>
          </FadeIn>
        </Section>
