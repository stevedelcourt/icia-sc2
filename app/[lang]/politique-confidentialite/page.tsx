    ...
    <>
      ...
      <main className="section pt-16">
        <div className="container-mentivis">
          <h1 className="t-display text-primary mb-12">{t(params.lang as Locale, 'confidentialite.title')}</h1>
          <div className="prose prose-lg max-w-none">
            <h2 className="t-heading text-primary mt-8 mb-4">{t(params.lang as Locale, 'confidentialite.responsable.title')}</h2>
            <p>{t(params.lang as Locale, 'confidentialite.responsable.text')}</p>
            
            <h2 className="t-heading text-primary mt-8 mb-4">{t(params.lang as Locale, 'confidentialite.donnees.title')}</h2>
            <p>{t(params.lang as Locale, 'confidentialite.donnees.text')}</p>
            
            <h2 className="t-heading text-primary mt-8 mb-4">{t(params.lang as Locale, 'confidentialite.utilisation.title')}</h2>
            ...
            <h2 className="t-heading text-primary mt-8 mb-4">{t(params.lang as Locale, 'confidentialite.droits.title')}</h2>
            <p>{t(params.lang as Locale, 'confidentialite.droits.text')}</p>
            
            <h2 className="t-heading text-primary mt-8 mb-4">{t(params.lang as Locale, 'confidentialite.duree.title')}</h2>
            <p>{t(params.lang as Locale, 'confidentialite.duree.text')}</p>
            
            <h2 className="t-heading text-primary mt-8 mb-4">{t(params.lang as Locale, 'confidentialite.cookies.title')}</h2>
