        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start mb-24">
            <StaggerBlock>
              ...
              <Link href="/contact" className="inline-block px-10 py-4 text-lg text-white bg-black hover:bg-gray-800 transition-colors duration-200">{t('acteurs.grand_public.cta')}</Link>
            </StaggerBlock>
