      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 mt-8">
          <div>
            ...
            <Link href="/contact" className="text-sm text-gray-400 hover:text-white transition-colors duration-200 mt-1 block">{t('contact.email.local')}&#x40;{t('contact.email.domain')}</Link>
