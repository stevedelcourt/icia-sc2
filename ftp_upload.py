...
REMOTE_HOST = 'sc2bovu7233.universe.wf'
REMOTE_USER = 'sc2bovu7233'
REMOTE_PASS = 'RoxanPascalSteven2024'
...
def sync_to_remote():
    ...
    # Check which files exist remotely using SIZE
    remote_files = set()
    ...
    # Delete stale files - each in its own connection to avoid cwd issues
    ...
    # Upload files - batch by top-level directory to minimize reconnects
    ...
    # Group by top-level dir for batching
    ...
    # Restore .htaccess.pagespeed.bkp if needed
    bkp_path = '/Users/stv/Documents/zed/icia-sc2/public/.htaccess.pagespeed.bkp'
    if os.path.exists(bkp_path) and '.htaccess.pagespeed.bkp' not in remote_files:
        print('\nRestoring .htaccess.pagespeed.bkp...')
        ftp = connect()
